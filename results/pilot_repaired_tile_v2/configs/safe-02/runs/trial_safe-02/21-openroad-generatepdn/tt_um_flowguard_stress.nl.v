module tt_um_flowguard_stress (clk,
 ...
 sky130_fd_sc_hd__dfrtp_2 _1251_ (.CLK(clk),
    ...
    .RESET_B(rst_n),
    .Q(\window0[5] ));
 sky130_fd_sc_hd__conb_1 _1252_ (.LO(uio_oe[0]));
 sky130_fd_sc_hd__conb_1 _1253_ (.LO(uio_oe[1]));
 sky130_fd_sc_hd__conb_1 _1254_ (.LO(uio_oe[2]));
 sky130_fd_sc_hd__conb_1 _1255_ (.LO(uio_oe[3]));
 sky130_fd_sc_hd__conb_1 _1256_ (.LO(uio_oe[4]));
 sky130_fd_sc_hd__conb_1 _1257_ (.LO(uio_oe[5]));
 sky130_fd_sc_hd__conb_1 _1258_ (.LO(uio_oe[6]));
 sky130_fd_sc_hd__conb_1 _1259_ (.LO(uio_oe[7]));
 sky130_fd_sc_hd__conb_1 _1260_ (.LO(uio_out[0]));
 sky130_fd_sc_hd__conb_1 _1261_ (.LO(uio_out[1]));
 sky130_fd_sc_hd__conb_1 _1262_ (.LO(uio_out[2]));
 sky130_fd_sc_hd__conb_1 _1263_ (.LO(uio_out[3]));
 sky130_fd_sc_hd__conb_1 _1264_ (.LO(uio_out[4]));
 sky130_fd_sc_hd__conb_1 _1265_ (.LO(uio_out[5]));
 sky130_fd_sc_hd__conb_1 _1266_ (.LO(uio_out[6]));
 sky130_fd_sc_hd__conb_1 _1267_ (.LO(uio_out[7]));
endmodule
